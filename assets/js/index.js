window.onload = function () {
    ...
    xhttp.open("GET", "http://localhost:7000/get-featured-courses", true);
    xhttp.send();
    ...
    xhttp2.open("GET", "http://localhost:7000/get-statistics")
    xhttp2.send()
...
document.getElementById("form-submit").addEventListener("click", function(){
    ...
    xhttp.open("POST", "http://localhost:7000/contact-us-submission")
